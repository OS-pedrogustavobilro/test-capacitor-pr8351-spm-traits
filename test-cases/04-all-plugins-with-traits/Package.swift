...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/ionic-team/capacitor-haptics.git", from: "8.0.0", traits: ["PrivacyManifest"]),
        .package(url: "https://github.com/ionic-team/capacitor-keyboard.git", from: "8.0.0", traits: ["PrivacyManifest"])
    ],
    targets: [
        .target(
            name: "TestApp",
